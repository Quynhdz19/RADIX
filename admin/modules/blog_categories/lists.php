                        ...
                        if (!empty($listCate)):
                            foreach ($listCate as $key => $item):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo getLinkAdmin('blog_categories', 'delete', ['id'=>$item['id']]); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xoá?')"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php
                            endforeach;
